				...
				<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
					...
					<div class="mb-6">
						...
						<div class="mt-4 grid grid-cols-2 gap-4">
							...
							<input wire:model='city' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('city') border-red-500 @enderror" id="city" type="select">
							</input>
							@error('city')
									<div class="text-red-500 text-sm">{{ $message }}</div>	
								@enderror
							...
							<div>
								...
								<select disabled wire:model="shipping_method" class=" w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('shipping_method') border-red-500 @enderror" id="shipping_method" >
					...
					<ul class="grid w-full gap-6 md:grid-cols-2">
						<li>
							<input wire:model='payment_method' name="ads" class="hidden peer" id="hosting-small" type="radio" value="cod">
						...
						<li>
							<input wire:model='payment_method' name="ads" class="hidden peer" id="hosting-big" type="radio" value="stripe">
			...
			<div class="md:col-span-12 lg:col-span-4 col-span-12">
				<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
					...
					<div class="flex justify-between mb-2 font-bold">
						...
						<span>
							{{ str_replace(',00', '', Number::currency($grand_total, 'IDR', 'id')) }}
						</span>
					</div>
					<div class="flex justify-between mb-2 font-bold">
						<span>
				...
				<div class="bg-white mt-4 rounded-xl shadowp p-4 sm:p-7 dark:bg-slate-900">
					<div class="text-xl font-bold underline text-gray-700 dark:text-white mb-2">
						BASKET SUMMARY
					</div>
						...
						<li class="py-3 sm:py-4" wire:key="{{ $ci['product_id'] }}">
							<div class="flex items-center">
								...
								<div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
									{{ str_replace(',00', '', Number::currency($ci['total_amount'], 'IDR', 'id')) }}
								</div>
							</div>
						</li>
