          ...
          <table class="w-full">
            ...
            <tbody>
              ...
              <tr wire:key="{{ $item->id }}">
                ...
                <td class="py-4">{{ str_replace(',00', '', Number::currency($item->unit_amount, 'IDR', 'id')) }}</td>
                <td class="py-4">
                  <span class="text-center w-8">{{ $item->quantity }}</span>
                </td>
                <td class="py-4">{{ str_replace(',00', '', Number::currency($item->total_amount, 'IDR', 'id')) }}</td>
              </tr>
              @endforeach
              <!--[if ENDBLOCK]><![endif]-->
      ...
      <div class="md:w-1/4">
        <div class="bg-white rounded-lg shadow-md p-6">
          ...
          <div class="flex justify-between mb-2">
            <span>Subtotal</span>
            <span>{{ str_replace(',00', '', Number::currency($item->order->grand_total, 'IDR', 'id')) }}</span>
          </div>
          <div class="flex justify-between mb-2">
            <span>Taxes</span>
            <span>0</span>
          ...
          <div class="flex justify-between mb-2">
            ...
            <span class="font-semibold">{{ str_replace(',00', '', Number::currency($item->order->grand_total, 'IDR', 'id')) }}</span>
          </div>
